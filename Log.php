<?php
include "Class/LastDayData.php";
include "Class/LastImportDay.php";
...
<div class="w3-container w3-margin">
    <button onclick="myFunction('PosledniData')" class="w3-btn w3-block w3-gray w3-left-align w3-card-4">Poslední stažená data...</button>
    <div id="PosledniData" class="w3-container w3-hide">

    <table class="w3-table-all w3-card-4">
    <?php
    $stockList = new LastDayData();
    $stockList->getLastDayData();
    ?>
        </table>
    </div>

    <button onclick="myFunction('PosledniDatum')" class="w3-btn w3-block w3-gray w3-left-align w3-card-4">Poslední stažené datum...</button>
    <div id="PosledniDatum" class="w3-container w3-hide">

    <?php
    $lastDay=new LastImportDate();
    $lastDay->getLastImportDay();
    ?>
